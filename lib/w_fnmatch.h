#ifndef	_W_FNMATCH_H_
#define	_W_FNMATCH_H_
...
#ifdef _MSC_VER
/* MSVC - PathMatchSpec  - requires LIBS += -lshlwapi */
#include <shlwapi.h>
...
/* I renamed fnmatch() to musl_fnmatch()
 * this define overrides any previous declaration of fnmatch() */
...
static int musl_fnmatch(const char *pat, const char *str, int flags)
{
	const char *s, *p;
	size_t inc;
	int c;
